            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  MesureCard(
                    regime: "import",
                    title: "FOURNIR UNE NOTIFICATION DES CONCLUSIONS DU CONTRÔLE DES PRODUITS VEGETAUX ET D'ORIGINE VEGETALE",
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => DetailsMesure(
                           titre: "FOURNIR UNE NOTIFICATION DES CONCLUSIONS DU CONTRÔLE DES PRODUITS VEGETAUX ET D'ORIGINE VEGETALE",
                            regime: "Import",
                            zone: "Maroc",
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(builder: (context) => DetailsMesure(
                           titre: "FOURNIR LA FACTURE DÛEMENT VISEE",
                            regime: "Import",
                            zone: "Maroc",
                            titreEtablisement: "DÉPARTEMENT DE LA SANTÉ (DIRECTION DU MÉDICAMENT ET DE LA PHARMACIE)",

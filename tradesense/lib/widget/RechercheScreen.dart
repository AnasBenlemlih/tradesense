...
class RechercheScreen extends StatefulWidget {
  ...
  const RechercheScreen(
      {Key key,
      this.titre,
      this.rechercheHintText,
      this.hintTextLeft,
      this.hintTextRight,
      this.hintTextBottom,
      this.textFieldLeftValues,
      this.textFieldRightValues,
      this.textFieldBottomValues,
      this.textFieldBottomIsShown,
      this.themeColor,
      this.previousScreen})
      : super(key: key);
            ...
            children: <Widget>[
                      ...
                      child: DropdownButtonHideUnderline(
                        child: ButtonTheme(
                          ...
                          child: DropdownButton<String>(
                            ...
                            items:
                                widget.textFieldLeftValues.map((String value) {
                        ...
                        child: DropdownButtonHideUnderline(
                          child: ButtonTheme(
                            ...
                            child: DropdownButton<String>(
                              ...
                              items: widget.textFieldRightValues
                                  .map((String value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: Text(value),
              ...
              Row(
                children: <Widget>[
                  SizedBox(width: 20.0),
                  Expanded(
                      child: widget.textFieldBottomIsShown == true
                          ? Container(
                              height: 45.0,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(40),
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: ButtonTheme(
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      items: widget.textFieldBottomValues
                                          .map((String value) {
                                        return DropdownMenuItem<String>(
                                          value: value,
                                          child: Text(value),
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => ListeProc(
                                    title: "Procédure d'import au Maroc",
                                    proc1:
                                        "AUTORISER L'EMBARQUEMENT À L'EXPORTATION",
                                    proc2:
                                        "CONTRÔLE À L’IMPORTATION DES PRODUITS INDUSTRIELS",
                                    proc3: "DÉPOSER LA DÉCLARATION DUM",
                                    proc4:
                                        "DÉPOSER LA DEMANDE D'ABONNEMENT AU SERVICE PORTNET")),
                          );
                        },
